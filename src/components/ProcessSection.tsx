...
const ProcessSection = () => {
  ...
  return (
    <section id="process" className="container bg-background py-16 md:py-24">
      ...
      <div className="relative grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4 w-full">
        {/* Horizontal connector line for desktop */}
        <motion.div
          ref={lineRef}
          className="absolute top-[30px] left-0 right-0 h-1.5 bg-primary/30 z-0 hidden lg:block"
          initial={{ width: 0 }}
