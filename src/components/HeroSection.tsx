...
const HeroSection = () => {
  return (
    ...
    >
      ...
      <div className="container z-10 text-center"> {/* Changed md:text-left to text-center */}
        ...
        <p className="mx-auto mb-10 max-w-3xl text-lg md:text-xl text-primary-foreground/80"> {/* Removed md:mx-0 */}
        ...
        <div className="flex flex-col justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0"> {/* Changed md:justify-start to justify-center */}
          <Link to="/projecten">
            <Button 
              size="lg" 
